...
### What is Pyviko?
Pyviko stands for Python Viral Knockouts (stylized: pyViKO). Pyviko is a tool for designing molecular cloning protocols in complex viruses or other organisms with overlapping genes. [Check out the paper in BMC Microbiology for more information](https://bmcmicrobiol.biomedcentral.com/articles/10.1186/s12866-016-0920-3).
