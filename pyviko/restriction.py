...
def findNcutters(seq, n, rSites = None):
	...
	'''
	#TODO: can optimize as in js--only traverse once, don't even need nmers
...
def defaultEnzymes():
	'''
	p = os.path.dirname(inspect.getabsfile(reFindEnzymes)) #doesn't work unless from within file
	print p
	print os.getcwd()
	try:
		x = open('t.txt', 'r')
